    ...
    <>
      ...
      <div className="flex flex-wrap justify-around p-5 items-center gap-y-40 mb-10 ">
        {myProjects.map((project) => (
          <div key={project.id}>
            <div className="group flex flex-col justify-start items-start gap-2 lg:w-[500px] sm:w-[330px] lg:h-[300px] sm:h-[250px] duration-500 relative rounded-lg p-4 bg-slate-100 hover:-translate-y-2 hover:shadow-lg hover:shadow-slate-500 cursor-pointer ">
              <div
