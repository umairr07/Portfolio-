...
import pixtf from "../../photos/pix.png";
function PixTransformer() {
  return (
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className="text-center text-2xl font-bold mb-6">Pix Transformer</p>
          <img src={pixtf} alt="" />
          <div className="flex justify-around mt-10">
            <div>
              <a href="https://pix-transformer.vercel.app/">
                <span>Go Live</span>
              </a>
              {/* <FaLink /> */}
            </div>
            <div>
              <a href="https://github.com/umairr07/PixTransformer">
                <span>Github</span>
              </a>
              {/* <FaGithub /> */}
            </div>
